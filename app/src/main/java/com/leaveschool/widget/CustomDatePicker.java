package com.leaveschool.widget;
...
public class CustomDatePicker {
    ...
    public interface ResultHandler {
        void handle(String time, String requester);
    }
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                time = removeMdPre(time);
                handler.handle(time, requester);
                datePickerDialog.dismiss();
            }
        });
    }
    /*去除month或day前面的0*/
    private String removeMdPre(String time) {
        if(time == null){
            return "";
        }
...
//        time = "test";
    ...
    public void show(String time, String requester) {
